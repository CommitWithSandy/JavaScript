...
that returns "The vehicle is moving". Then, override the move() method in the Car class to return "The car is driving".
*/ 
/*
Task 3: Static Methods in Classes
Add a static method isVehicle(obj) to the Vehicle class that 
checks if a given object is an instance of Vehicle. 
...
class Car extends Vehicle{
    ...
    move(){
        return `The Vehical is driving`
    }
}
let myCar = new Car("BMW","M4 Competiton")
